...
export const FormDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    ...
    return <p ref={ref} id={formDescriptionId} className={cn('text-2xs text-foreground-muted', className)} {...props} />
  }
)
...
export const FormMessage = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, children, ...props }, ref) => {
    ...
    const t = useTranslations('messages.validation')
    ...
    return (
      <p ref={ref} id={formMessageId} className={cn('text-2xs font-medium text-destructive', className)} {...props}>
        {t(body as Validation)}
      </p>
    )
  }
)
