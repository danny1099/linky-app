    ...
    <div className='space-y-8'>
      <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {dailyClicksData.length > 0 ? Math.round(totalClicks / dailyClicksData.length) : 0}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>{referrerData[0]?.name.slice(0, 12) || 'N/A'}</div>
            <p className='text-xs text-muted-foreground'>{referrerData[0]?.value || 0} clicks</p>
          </CardContent>
        </Card>
      </div>
